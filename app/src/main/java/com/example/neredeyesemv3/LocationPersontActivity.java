...
public class LocationPersontActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks,
    ...
    public void initalPermission()
    {

// we need to manage Location Permissions.
// In the onCreate method of our Activity,
// we will request these permissions by calling the requestPermissions method
                ...
                if (permissionsRejected.size() > 0) {
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                        if (shouldShowRequestPermissionRationale(permissionsRejected.get(0))) {
                            new AlertDialog.Builder(LocationPersontActivity.this).
